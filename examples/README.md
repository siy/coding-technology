...
Notes
- The code references Pragmatica Core types (`Option`, `Result`, `Promise`, `Causes`, `Verify`).
- Pragmatica Core 1.0.0-rc1 is available on Maven Central.
...
Build
- Pragmatica Core `org.pragmatica-lite:core:1.0.0-rc1` is declared in parent POM and available from Maven Central.
