...
- Pragmatica Core 0.25.0 is available on Maven Central.
...
Build
- Pragmatica Core `org.pragmatica-lite:core:0.25.0` is declared in parent POM and available from Maven Central.
