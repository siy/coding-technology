...
Start Here
- Read `TECHNOLOGY.md` for the framework‑agnostic methodology: return kinds, parse‑don’t‑validate, steps, package layout, aspects, and testing.

Collaboration Protocol
- Read `CLAUDE.md` before asking for or producing any output.
