...
@DisplayName("Auction Exercise Tests")
class AuctionExerciseTest {
    ...
    class LeafMethods {
        ...
        void acceptsFutureDeadline() {
            ...
            Result<Instant> result = AuctionExercise.checkDeadlineExercise(future);
        ...
        void rejectsPastDeadline() {
            ...
            Result<Instant> result = AuctionExercise.checkDeadlineExercise(past);
        ...
        void acceptsBidAtFloor() {
            ...
            Result<BigDecimal> result = AuctionExercise.applyFloorExercise(bid, floor);
    ...
    class SequencerPattern {
        ...
        void evaluatesValidBid() {
            ...
            Result<Bid> result = AuctionExercise.evaluateBidExercise(response, request);
    ...
    class IterationPattern {
        ...
        void returnsValidBids() {
            ...
            Result<List<Bid>> result = AuctionExercise.evaluateAllBidsExercise(responses, validRequest);
        ...
        void failsWithEmptyList() {
            Result<List<Bid>> result = AuctionExercise.evaluateAllBidsExercise(List.of(), validRequest);
    ...
    class Selection {
        ...
        void returnsHighestBid() {
            ...
            Result<Bid> result = AuctionExercise.selectWinnerExercise(bids);
        ...
        void failsWithEmptyList() {
            Result<Bid> result = AuctionExercise.selectWinnerExercise(List.of());
