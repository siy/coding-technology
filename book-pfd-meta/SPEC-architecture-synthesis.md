...
- `(private path)` — **canonical module outline L503–527**; axes L137–148; Phase-4 L104–131; recovery L179–208; continuous-transformation L150–177.
- `(private path)` — Theme 3 (L171–196, emergence-first), 6 (show possibility), 18 (L618–672, Temporal), 19 (L676–792), 22 (synthesis-is-a-module), 23 (L1309–1335, esp #4 L1332), 25 (determinism phase-scoped), 26 (integrative-not-delta).
- `(private path)` — Gap 3 (recovery), Gap 5 (Phase-4 set), Gap 6 (six-axis); infeasible-vector contrast cases L668–676, L819–825; hybrid-normal L815.
- `(private path)` — register, em-dash, three-layer/named-device model, forbidden vocab, positive-crediting rule.
