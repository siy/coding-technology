...
- Pragmatica Core 1.0.0-rc3 is available on Maven Central.
...
Build
- Pragmatica Core `org.pragmatica-lite:core:1.0.0-rc3` is declared in parent POM and available from Maven Central.
