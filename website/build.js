...
// Book chapters (slug filenames; order = book/root.md spine. Interim list — the
// course templates replace this wholesale in the redesign.)
const BOOK_CHAPTERS = [
  'introduction.md',
  'from-process-to-patterns.md',
  'four-return-types.md',
  'pragmatica-core-essentials.md',
  'parse-dont-validate.md',
  'error-handling.md',
  'null-policy-recovery.md',
  'basic-patterns.md',
  'advanced-patterns.md',
  'knowledge-gathering-pipelines.md',
  'thread-safety.md',
  'testing-philosophy.md',
  'testing-practice.md',
  'registeruser-example.md',
  'placeorder-example.md',
  'publisharticle-example.md',
  'transferfunds-example.md',
  'project-structure.md',
  'systematic-application.md',
