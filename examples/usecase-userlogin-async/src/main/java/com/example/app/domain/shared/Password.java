...
public record Password(String value) {
    private static final Functions.Fn1<Cause, String> MISSING_PASSWORD = Causes.forValue("Missing email address");
    private static final Functions.Fn1<Cause, String> TOO_SHORT_PASSWORD = Causes.forValue("Too short");
    private static final Functions.Fn1<Cause, String> NOT_DIVERSE_PASSWORD = Causes.forValue(
