...
The current candidate is 1.0.0-rc3 (2026-09-02). It is on Maven Central as `org.pragmatica-lite:core:1.0.0-rc3` and the published `org.pragmatica-lite.aether` artifacts at `1.0.0-rc3`; binaries are on the [GitHub release](https://github.com/pragmaticalabs/pragmatica/releases/tag/v1.0.0-rc3).
