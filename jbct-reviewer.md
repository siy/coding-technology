...
JBCT uses **Pragmatica Lite Core 0.9.8** for functional types (`Option`, `Result`, `Promise`).
...
- ❌ Outdated version (e.g., `0.7.x`, `0.8.x`, `0.9.0`-`0.9.7`)
- ✅ Correct: `org.pragmatica-lite:core:0.9.8`
...
- [ ] Correct version: `0.9.8` (not `0.7.x`, `0.8.x`, `0.9.0`, `0.9.1`, `0.9.2`)
- [ ] Full coordinates: `org.pragmatica-lite:core:0.9.8`
...
- ❌ Outdated version: `0.9.0` → should be `0.9.8`
